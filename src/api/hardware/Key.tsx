    ...
    <>
      ...
      {keyType == "sonsei-t1" ? (
        ...
        >
          <g className="shadowHover" transform={`translate(${0},${3})`}>
            <path
              d="M0 4.989a4 4 0 014-4h49.202a4 4 0 013.994 4.217l-2.39 43.81a4 4 0 01-3.994 3.783H4a4 4 0 01-4-4V4.989z"
              fill={color}
            />
          </g>
          ...
          <g transform={`translate(${4},${0})`}>
            <path
              d="M.826 4.989a4 4 0 014-4h43.522a4 4 0 013.992 4.244l-2.336 38.158a4 4 0 01-3.993 3.756H4.826a4 4 0 01-4-4V4.989z"
              className="keyBase"
            />
            <path
              d="M.826 4.989a4 4 0 014-4h43.522a4 4 0 013.992 4.244l-2.336 38.158a4 4 0 01-3.993 3.756H4.826a4 4 0 01-4-4V4.989z"
      ...
      {keyType == "sonsei-tR1" ? (
        ...
        >
          <g className="shadowHover" transform={`translate(${0},${3})`}>
            <path
              d="M57.426 4a4 4 0 00-4-4H4.224A4 4 0 00.23 4.218l2.39 43.81a4 4 0 003.994 3.782h46.812a4 4 0 004-4V4z"
              fill={color}
            />
          </g>
          ...
          <g className="shadowMiddle" transform={`translate(${0},${12})`}>
            <path
              d="M51.6 4a4 4 0 00-4-4H4.077A4 4 0 00.086 4.244l2.336 38.159a4 4 0 003.992 3.755H47.6a4 4 0 004-4V4z"
              fill={color}
            />
          </g>
          <g transform={`translate(${4},${0})`}>
