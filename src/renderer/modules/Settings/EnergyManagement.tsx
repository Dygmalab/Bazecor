    ...
    <Styles>
      <Card className="overflowFix card-preferences">
        ...
        <Card.Body className="py-0">
          <AdvancedBatterySettings wireless={wireless} changeWireless={changeWireless} toggleSavingMode={toggleSavingMode} />
          <SavingMode wireless={wireless} changeWireless={changeWireless} toggleSavingMode={toggleSavingMode} />
        </Card.Body>
      </Card>
    </Styles>
  );
