...
import CheckedIconLight from "@Assets/dark/icon-check-animated.gif";
import closeButton from "@Assets/light/X.svg";
...
const Light: DefaultTheme = {
  ...
  styles: {
    ...
    badge: {
      ...
      warningBG: settingColorOpacity(Tokens.colors.brandWarning, 0.15),
      warningText: settingColorOpacity(Tokens.colors.brandWarningLighter, 0.75),
    ...
    energyManagement: {
      ...
      descriptionColor: Tokens.colors.gray400,
      lowPowerModeTitleColor: Tokens.colors.gray200,
      shortButtonColor: Tokens.colors.brandSecondary,
    },
    raiseKeyboard: {
      keyBase: "#E2E4EA",
    ...
    navbar: {
      ...
      menuLink: {
        ...
        lightingOpacity: 0.5,
        gradient: "linear-gradient(236.53deg, #F0F2F4 1.37%, #                         117.2%)",
      },
    },
    neuronConnection: {
