...
const tabsTriggerVariants = cva("flex flex-col", {
  variants: {
    variant: {
      ...
      tab: "tab-item w-full flex flex-row text-left justify-start relative items-center gap-2 font-semibold mt-0 transition-all before:absolute before:w-[32px] before:h-[68px] before:right-[-24px] before:content-[''] before:bg-lightAccent before:opacity-0 before:transition-opacity before:duration-200 before:z-[1] dark:text-gray-100 after:content-[''] after:h-[24px] after:w-[3px] after:absolute after:rounded-tr-[3px] after:rounded-br-[3px] after:opacity-0 after:transition-opacity after:duration-200 after:bg-gradient-to-t after:from-secondary after:to-primary after:top-[50%] after:translate-y-[-50%] after:right-[-27px] after:z-[1] hover:dark:text-gray-25 text-gray-400 dark:text-gray-100 data-[state=active]:before:opacity-50 data-[state=active]:dark:before:opacity-100 data-[state=active]:after:opacity-100 data-[state=active]:text-purple-200 data-[state=active]:dark:text-gray-25",
    },
    size: {
