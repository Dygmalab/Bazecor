...
const LabelModifier = ({ label, size = "md" }: LabelModifierProps) => (
  <div
    className={`font-semibold tracking-tight rounded-xl backdrop-blur-sm flex justify-center items-center h-auto ${
      size === "md"
    ...
    ${size === "sm" ? "text-gray-200 bg-gray-600/60 px-[6px] py-[4px] text-[10px]" : ""}`}
  >
